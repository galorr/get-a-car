...
export class RegistrationComponent {
  ...
  registerUser(): void {
    ...
    // Register the user
    this.registrationService.registerUser({ ...this.newUser });
  ...
  registerCarToCurrentUser(): void {
    ...
    if (user && car) {
      this.registrationService.registerCarToUser(user.id, car.id);
      this.currentUser.set(this.registrationService.currentUser());
      this.cdr.detectChanges();
    }
  }
  ...
  unregisterCar(carId: string): void {
    ...
    if (user) {
      this.registrationService.unregisterCarFromUser(user.id, carId);
      this.currentUser.set(this.registrationService.currentUser());
      this.cdr.detectChanges();
    }
  }
